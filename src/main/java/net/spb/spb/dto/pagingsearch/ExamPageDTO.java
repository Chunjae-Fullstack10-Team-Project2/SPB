...
public class ExamPageDTO extends PageDTO {
    ...
    @Builder.Default
    private String sort_by = "examIdx";
    @Builder.Default
    private String sort_direction = "desc";

    private static final List<String> SORT_COLUMNS = List.of("examIdx", "examTitle", "examStartDate", "examCreatedAt");
    private static final List<String> SORT_DIRECTIONS = List.of("asc", "desc");

    public String getSort_by() {
        return SORT_COLUMNS.contains(this.sort_by) ? this.sort_by : "examIdx";
    }
    ...
    public String getLinkUrl() {
        ...
        if (this.lectureIdx > 0) {
            sb.append("&lectureIdx=" + this.lectureIdx);
        }
