...
public class LectureController {
    ...
    public String playVideo(@RequestParam("chapterLectureIdx") int chapterLectureIdx, @RequestParam("chapterIdx") int chapterIdx, Model model) {
        ChapterDTO chapter = lectureService.getChapterById(chapterLectureIdx, chapterIdx);
