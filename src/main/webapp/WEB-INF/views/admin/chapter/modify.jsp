...
<div class="content">
  ...
  <div class="container my-5">
    <div class="card shadow rounded">
      ...
      <div class="card-body">
        <form name="frmRegist" method="post" action="/admin/chapter/modify"
              id="frmRegist" novalidate class="needs-validation" enctype="multipart/form-data">
          <input type="hidden" name="chapterIdx" value="${chapterDTO.chapterIdx}"/>
          <input type="hidden" id="chapterLectureIdx" name="chapterLectureIdx"
                 value="${chapterDTO.chapterLectureIdx != null ? chapterDTO.chapterLectureIdx : '0'}">
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input type="hidden" name="chapterRuntime" value="${chapterDTO.chapterRuntime}"/>
            <div class="form-text invalid-feedback">강의 동영상은 100MB 이하여야 합니다.</div>
          </div>
