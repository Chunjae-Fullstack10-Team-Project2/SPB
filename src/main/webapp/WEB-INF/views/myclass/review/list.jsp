    ...
    <div class="content">
        <div class="container my-5">
            ...
            <%
                ...
                request.setAttribute("searchAction", "/myclass/review");
            %>
                ...
                <table class="table table-hover text-center align-middle">
                    ...
                    <thead class="table-light">
                        <tr>
                            ...
                            <th>
                                <a onclick="applySort('lectureReviewMemberId')">
                                    작성자
                                    <c:if test="${pageDTO['sort_by'] eq 'lectureReviewMemberId'}">
                                        ${pageDTO['sort_direction'] eq 'asc' ? '▲' : '▼'}
                                    </c:if>
                                </a>
                            </th>
                    ...
                    <tbody>
                        <c:forEach items="${reviewList}" var="review" varStatus="status">
                            <tr class="clickable-row"
                                ...
                                <td>${review.lectureReviewMemberId}</td>
