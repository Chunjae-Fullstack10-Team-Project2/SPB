        ...
        <div class="article-board">
          ...
          <table class="table">
            ...
            <tbody>
              ...
              <tr>
                <td colspan="6"><div class="article-paging">${paging}</div></td>
              </tr>
              <tr>
                <td colspan="6"><button type="button" class="btn btn-outline-dark" id="btnRegist">글 작성</button></td>
              </tr>
            </tbody>
          </table>
        </div>
      <div class="search-box">
        <form name="frmSearch" action="" method="get">
          ...
          <div class="search-box-word">
            ...
            <input type="text" name="search_word" value="${search.search_word}"/> <button type="submit" class="btn" id="btnSearch">검색</button>
