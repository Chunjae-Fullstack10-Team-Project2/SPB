...
<div class="flex-shrink-0 p-3 sidebar" id="sidebar">
    <ul class="list-unstyled ps-0">
        ...
        <c:if test="${sessionScope.memberGrade eq 13}">
            <li class="mb-3">
                <button class="btn btn-toggle d-inline-flex align-items-center collapsed mb-2" data-bs-toggle="collapse"
                        data-bs-target="#myclass-collapse">
                    나의강의실
                </button>
                <div class="collapse" id="myclass-collapse">
                    <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                        <li>
                            <a class="d-inline-flex text-decoration-none rounded text-dark"
                               href="${cp}/myclass/lecture">내 강의 목록</a>
                        </li>
                        <li>
                            <a class=" d-inline-flex text-decoration-none rounded text-dark"
                               href="${cp}/myclass/notice">공지사항</a>
                        </li>
                        <li>
                            <a class=" d-inline-flex text-decoration-none rounded text-dark"
        ...
        <c:if test="${sessionScope.memberId ne null and sessionScope.memberGrade ne 13 and sessionScope.memberGrade ne 0}">
            <li class="mb-3">
                <button class="btn btn-toggle d-inline-flex align-items-center collapsed mb-2" data-bs-toggle="collapse"
                        data-bs-target="#mystudy-collapse">
                    나의학습방
                </button>
                <div class="collapse" id="mystudy-collapse">
                    <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                        <li>
                            <a class="d-inline-flex text-decoration-none rounded text-dark"
                               href="${cp}/mystudy/lecture">내 강의 목록</a>
                        </li>
                        <li>
                            <a class=" d-inline-flex text-decoration-none rounded text-dark"
                               href="${cp}/mystudy/qna">Q&A</a>
                        </li>
                        <li>
                            <a class=" d-inline-flex text-decoration-none rounded text-dark"
                               href="${cp}/mystudy/grade">나의성적</a>
                        </li>
                        <li>
                            <a class=" d-inline-flex text-decoration-none rounded text-dark"
                               href="${cp}/mystudy/review">수강후기</a>
                        </li>
                        <li>
                            <a class=" d-inline-flex text-decoration-none rounded text-dark"
                               href="${cp}/mystudy/plan">학습계획표</a>
                        </li>
                    </ul>
                </div>
            </li>
