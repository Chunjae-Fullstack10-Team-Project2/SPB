...
<div class="my-page-container mt-5 mb-5">
    ...
    <form name="frmMyPage" id="frmMyPage" action="/mypage" method="post">
        ...
        <div class="form-floating mb-3">
            <input type="text" class="form-control" id="memberBirth" name="memberBirth" value="${memberDTO.memberBirth}"
        ...
        <div class="form-floating mb-3">
            <input type="text" class="form-control" id="memberAddr1" name="memberAddr1" value="${memberDTO.memberAddr1}"
                   placeholder="주소" required>
            <label for="memberAddr1">주소</label>
        </div>

        <div class="form-floating mb-3">
            <input type="text" class="form-control" id="memberAddr2" name="memberAddr2" value="${memberDTO.memberAddr2}"
                   placeholder="상세주소">
            <label for="memberAddr2">상세주소</label>
        </div>

        <div class="text-end d-grid gap-2">
            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#pwdModal">정보 수정</button>
        </div>
    </form>
</div>
