...
<body class="d-flex align-items-center py-4 bg-light text-center">
...
<%--                 height="57">--%>
            ...
            <a href="https://nid.naver.com/oauth2.0/authorize?response_type=code&client_id=cnVwGS7uEm_5bo6jAIGr&redirect_uri=http://localhost:8080/naver/callback&state=randomState123" class="naver-login-button d-flex align-items-center justify-content-center">
                <img src="resources/img/btnW_icon_square.png" alt="네이버 로그인 버튼" width="25" style="margin-right: 0.5rem"/>
                네이버로 계속하기
            </a>
        </form>
    </main>
