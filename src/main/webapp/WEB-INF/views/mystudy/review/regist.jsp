...
<body>
    ...
    <div class="content">
        <div class="container my-5">
            ...
            <h1 class="h2 mb-4">수강후기 등록</h1>

            <form name="frmRegist" action="/mystudy/review/regist" method="post"
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" name="lectureReviewRefIdx" id="lectureReviewRefIdx">
                        <option value="" ${ param.idx eq null and review.lectureReviewRefIdx eq null ? "selected" : ""}>
                            강좌를 선택하세요.
                        </option>
                        <c:forEach items="${lectureList}" var="lecture">
                            <option value="${lecture.lectureIdx}"
                                ${(param.idx ne null and param.idx eq lecture.lectureIdx) or
                                  (review.lectureReviewRefIdx ne null and review.lectureReviewRefIdx eq lecture.lectureIdx) ? "selected" : ""}>
